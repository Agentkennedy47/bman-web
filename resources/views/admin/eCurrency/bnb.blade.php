        	...
        	<div class="col-xl-6 col-xxl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add BNB</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('update.bnb') }}" method="POST">

                                @csrf

                                <input type="hidden" name="id" value="{{ $bnbPage->id }}">

                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Buy</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="bnb_buy" class="form-control" value="{{ $bnbPage->bnb_buy }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Sell</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="bnb_sell" class="form-control" value="{{ $bnbPage->bnb_sell }}">
