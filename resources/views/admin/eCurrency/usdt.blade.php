        	...
        	<div class="col-xl-6 col-xxl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add USDT</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('update.usdt') }}" method="POST">

                                @csrf

                                <input type="hidden" name="id" value="{{ $usdtPage->id }}">

                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Buy</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="usdt_buy" class="form-control" value="{{ $usdtPage->usdt_buy }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Sell</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="usdt_sell" class="form-control" value="{{ $usdtPage->usdt_sell }}">
