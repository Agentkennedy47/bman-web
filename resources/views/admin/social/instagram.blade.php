        	...
        	<div class="col-xl-6 col-xxl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">ADD INSTAGRAM LINK</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('update.instagram.link') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="instagram_link" class="form-control" value="{{ $instagram->instagram_link }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
